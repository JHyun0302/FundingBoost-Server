...
class GiftHubItemRepositoryImplTest {
    ...
    @Test
    void findGiftHubItemsByMember() throws NoSuchFieldException, IllegalAccessException {
        ...
        //given
        List<GiftHubItem> result = giftHubItemRepository.findGiftHubItemsByMember(savedMember.getMemberId());

        //then
        assertThat(result.size()).isEqualTo(1);
        assertThat(result.get(0).getGiftHubItemId()).isEqualTo(savedGiftHubItem.getGiftHubItemId());
        assertThat(result.get(0).getMember().getNickName()).isEqualTo(savedMember.getNickName());
        assertThat(result.get(0).getItem().getItemName()).isEqualTo(savedItem.getItemName());
    }
}