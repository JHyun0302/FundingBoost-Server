...
public class ItemFixture {
    ...
    public static Item item3() {
        return Item.createItem("코코 마드모아젤 헤어 미스트 35ml", 85000,
    ...
    public static Item item4() {
        return Item.createItem("레 베쥬 립 밤", 85000,
    ...
    public static Item item5() {
        return Item.createItem("[단독+각인+포장] 입생로랑 1위 NEW 벨벳 틴트 세트(+리브르 향수 1.2ml)", 49000,
    ...
    public static List<Item> items5() {
