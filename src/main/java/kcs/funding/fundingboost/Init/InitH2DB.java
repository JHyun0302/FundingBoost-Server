...
public class InitH2DB {
    ...
    public void init() {
        ...
        initService.initBeauty();
        initService.initOrder();
        initService.initFunding();
        initService.initDelivery();
        initService.initRelationships();
    }
    ...
    static class InitService {
        ...
        public void initMember() {
            member1 = Member.createMember("구태형", "rnxogud136@gmail.com", "",
            ...
            member2 = Member.createMember("맹인호", "aoddlsgh98@gmail.com", "",
        ...
        public void initBeauty() {
            ...
            Item item4 = Item.createItem("레 베쥬 립 밤", 85000,
            ...
            Item item5 = Item.createItem("[단독+각인+포장] 입생로랑 1위 NEW 벨벳 틴트 세트(+리브르 향수 1.2ml)", 49000,
            ...
            Item item6 = Item.createItem("[선물포장] 리브르 핸드 크림 30ml", 33000,
            ...
            Item item7 = Item.createItem("[각인+포장] NEW 엉크르 드 뽀 쿠션 세트(+라운드 파우치)", 108000,
            ...
            Item item8 = Item.createItem("[단독/리미티드선물포장] 코롱 9ML", 32000,
            ...
            Item item9 = Item.createItem("[선물포장] 바디 크림 50ML", 45000,
            ...
            Item item10 = Item.createItem("[단독각인/슬리브선물포장] 코롱 30ML", 110000,
