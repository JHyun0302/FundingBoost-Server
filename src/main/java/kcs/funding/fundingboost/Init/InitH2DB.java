...
public class InitH2DB {
    ...
    /**
     * 1. member
     * 임(1), 구(2), 맹(3), 양(4), 이(5), 현(6)
     * 2. items
     * Beauty 10개
     * 3. delivery
     * 임창희(id=1) 배송지 2개(id=0, id=1)
     * 구태형(id=2) 배송지 1개(id=2)
     * 4. order
     * 1 : 임창희, 배송지1 -> order(id=0)
     * 2 : 구태형, 배송2 -> order(id=1)
     * 5. funding & gifthub
     * ==========================================================
     * * member1(임창희관련) 초기화
     * * 장바구니 2개 추가
     ...
     * ==========================================================
     * 6. relationship
     * 구태형 - 임창희 친구 관계 설정 -> relationship(id=0)
     * 7. contributor
     */
    @PostConstruct
    ...
    static class InitService {
        ...
        public void initOrders(List<Member> members, List<Item> items, List<Delivery> deliveries) {
            ...
            Order order1 = Order.createOrder(1, 10700, false, item1, member1, delivery1);
            Order order2 = Order.createOrder(1, 17820, false, item2, member2, delivery2);
            em.persist(order1);
            em.persist(order2);
        }
        ...
        public void initFunding(List<Member> members, List<Item> items) {
            ...
            Funding funding3 = Funding.createFundingWithCollectPrice(member1, "생일 축하~",
                Tag.BIRTHDAY, 100000,
            ...
            Funding funding4 = Funding.createFundingWithCollectPrice(member2, "드디어 졸업 성공~~",
                Tag.GRADUATE, 200000,
        ...
        public void initContributor(List<Member> members, List<Item> items) {
            ...
            Funding funding = Funding.createFunding(member, "줘", Tag.BIRTHDAY, 112000,
                LocalDateTime.now().plusDays(14));
            em.persist(funding);
